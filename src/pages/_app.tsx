...
export default function App({ Component, pageProps }: AppProps) {
  ...
  return (
    <>
      <Head>
        <meta charSet="utf-8" />
        <title>FilesMerger - Merge Files Effortlessly!</title>
        <link rel="icon" href="/favicon.ico" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="theme-color" content="#ffffff" />
        <meta name="keywords" content="files, merger, filesmerger, pwa, merge, file, image, quick, instant, free, web app" />
        <meta name="description" content="FilesMerger helps you quickly and easily merge multiple files into a single document." />
